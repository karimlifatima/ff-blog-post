        ...
        'Tinymce' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => false,
                    'location' => '//cdn.tiny.cloud/1/wfyioa439f4ugldph2btt0kd660v5o8wqr5aq25ytrbvg9v7/tinymce/5/tinymce.min.js',
                ],
            ],
        ],
        'BsCustomFileInput' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'vendor/plugins/bs-custom-file-input.js',
                ],
            ],
        ],
    ],
